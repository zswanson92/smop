...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-gray-900 border-gold border-b-2 px-4 py-2 flex justify-between items-center z-50">
      <Link href="/" passHref>
        <img src="/home_button.png" alt="Home" className="h-14 w-14 rounded-lg object-cover" style={{ objectFit: 'cover', objectPosition: 'center' }} />
      </Link>
      <Link href="/blog" passHref>
        <img src="/Screenshot_11.png" alt="Blog" className="h-14 w-14 rounded-lg object-cover" style={{ objectFit: 'cover', objectPosition: 'center' }} />
      </Link>
      <Link href="/aboutauthor" passHref>
        ...
        <img src="/Screenshot_31.png" alt="Blog" className="h-14 w-14 rounded-lg object-cover" />
      </Link>
      <Link href="/media" passHref>
        ...
        <img src="/Screenshot_32.png" alt="Blog" className="h-14 w-14 rounded-lg object-cover" />
      </Link>
      {!isLoggedIn ? (
        <>
        <button onClick={() => setShowLoginModal(true)} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', padding: '8px 12px', fontSize: '16px', cursor: 'pointer' }} className="text-silver hover:text-gold">
            ...
            <img src="/Screenshot_33.png" alt="Blog" className="h-14 w-14 rounded-lg object-cover" />
        </button>
        <button onClick={() => setShowSignupModal(true)} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', padding: '8px 12px', fontSize: '16px', cursor: 'pointer' }} className="text-silver hover:text-gold mr-4">
            ...
            <img src="/Screenshot_34.png" alt="Blog" className="h-14 w-14 rounded-lg object-cover" />
        </button>
        </>
      ) : (
