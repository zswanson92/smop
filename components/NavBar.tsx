  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-gray-900 border-gold border-b-2 px-4 py-2 flex justify-between items-center z-50">
      ...
      <Link href="/aboutauthor" passHref>
        <button onClick={logOut} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', padding: '8px 12px', fontSize: '16px', cursor: 'pointer' }} className="text-silver hover:text-gold color-silver"><GiPirateCaptain /> About the Author </button>
      </Link>
      <Link href="/media" passHref>
        <button onClick={logOut} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', padding: '8px 12px', fontSize: '16px', cursor: 'pointer' }} className="text-silver hover:text-gold color-silver"><GiPirateCannon /> Seven Minutes of Piracy Media </button>
      </Link>
      {!isLoggedIn ? (
        <>
        <button onClick={() => setShowLoginModal(true)} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', padding: '8px 12px', fontSize: '16px', cursor: 'pointer' }} className="text-silver hover:text-gold">
            Login <BiLogIn style={{ marginLeft: '8px' }} />
        </button>
        <button onClick={() => setShowSignupModal(true)} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', padding: '8px 12px', fontSize: '16px', cursor: 'pointer' }} className="text-silver hover:text-gold mr-4">
            Sign Up <CgUserAdd style={{ marginLeft: '8px' }} />
        </button>
        </>
      ) : (
